  ...
  return (
    <div className="dashboard-container">
      <div className="content-area">
        ...
        <Alert
          message="Внимание"
          description="Изменения вступят в силу после перезапуска бота. Используйте systemctl restart turner_bot"
          type="warning"
          showIcon
        ...
        <Tabs defaultActiveKey="texts">
          <TabPane tab="📝 Тексты бота" key="texts">
          ...
          <TabPane tab="🔧 Системные настройки" key="settings">
